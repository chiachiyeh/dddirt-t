...
class Mnist(object):
    def __init__(self):
        ...
        ptint('minst train: ', self.train.shape)
        print('minst test: ', self.test.shape)
...
class Svhn(object):
    def __init__(self, train='train'):
        ...
        ptint('svhn train: ', self.train.shape)
        print('svhn test: ', self.test.shape)
...
class Timg(object):
    def __init__(self):
        print('load Timg...')
        testx = np.load(args.datadir+'testX.npy')
        self.train = Data(testx[:9000], cast=True)
        self.test = Data(testx[9000:])
